...
// Replace k9-rs, K9 Rs — See README.adoc for details., just run, K9 Rs started successfully. with actuals
= k9-rs — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-rs?

K9 Rs — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./k9-rs-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-rs/wiki
