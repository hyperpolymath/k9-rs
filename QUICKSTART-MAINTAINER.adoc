...
// Replace k9-rs, {{PACKAGE_NAME}}, {{DEPS}} with actuals
...
This guide covers packaging, deploying, and maintaining k9-rs for
...
* Upstream: https://github.com/hyperpolymath/k9-rs/issues
